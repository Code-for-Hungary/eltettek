  ...
  return (
    <Layout history={props.history}>
      <div className={styles.about}>
          ...
          <section>
           <h2>A témáról megjelent írásaink</h>  
          ...
          <section>
           <h2>Hibát találtál? Jelezd felénk!</h>  
            <p>Büszkék vagyunk rá, hogy önkéntesek segítségével építettük az alkalmazást és nyitottak vagyunk minden észrevételre. Az adatok tetemes mennyisége és a kézzel végzett adattisztítás miatt a legalaposabb törekvésünk ellenére előfordulhat, hogy az oldalon hibát találsz. <a href="mailto:info@k-monitor.hu?subject=Eltették">Jelezd felénk</a>!</p>
          </section>
          <section>
           <h2>Köszönet</h>  
            <p>Az oldal fejlesztésében részt vevő <a href="https://code4.hu" target="new">Code for Hungary</a> önkénteseknek, <a href="http://feren.cz/" target="new">Ferencz Miklósnak</a> (grafika).</p>
            <p><a href="https://vercel.com/" target=new">Hosted on Vercel</a>.</p>
          </section>
      </div>
    </Layout>
  );
